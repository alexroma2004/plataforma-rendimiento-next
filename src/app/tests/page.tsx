  ...
  return (
    <main className="min-h-screen bg-slate-100 p-8 text-slate-950">
      <section className="rounded-2xl bg-slate-950 p-8 text-white shadow">
        ...
        <h1 className="mt-3 text-4xl font-black">Tests físicos</h1>

        <p className="mt-4 max-w-4xl text-sm leading-6 text-slate-200">
          Visualización de sesiones de tests guardadas en Supabase. Consulta las
          puntuaciones por capacidad, los resultados por variable y el ranking
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link
            href="/cargar-tests"
            className="rounded-xl bg-white px-5 py-3 text-sm font-black text-slate-950 shadow hover:bg-slate-100"
          >
      ...
      <section className="mt-8 rounded-2xl bg-white p-6 shadow">
        ...
        {!loadingSessions && sessions.length === 0 && (
          <div className="mt-6 rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm font-bold text-amber-700">
            Todavía no hay sesiones de tests guardadas. Primero carga una sesión
            desde el apartado de carga de tests.
          </div>
        )}
              ...
              <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-6 shadow">
                <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                  <div>
                    ...
                    <p className="mt-2 max-w-3xl text-sm text-slate-600">
                      Filtra los resultados para analizar una capacidad concreta
                      o revisa todas las puntuaciones de la sesión.
                    </p>
                  </div>
                ...
                <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow xl:col-span-2">
                  <div className="border-b border-slate-200 p-5">
                    ...
                    <p className="mt-1 text-sm text-slate-600">
                      Puntuación final calculada para cada jugador y capacidad.
                    </p>
                  </div>
